...
InlineCurrentSense::InlineCurrentSense(float _shunt_resistor, float _gain, int _pinA, int _pinB, int _pinC){
    ...
    volts_to_amps_ratio = 1 / 0.667f / 0.2f;
...
PhaseCurrent_s InlineCurrentSense::getPhaseCurrents(){
    ...
    // printf("offset_ia:%0.3f gain_a:%0.3f pinA:%0.3f pinB:%0.3f\n", 
    //     offset_ia, gain_a, _readADCVoltageInline(pinA, params), _readADCVoltageInline(pinB, params));
